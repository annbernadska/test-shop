...
class Pagination{
    private $max = 3; //     * @var Ссылок навигации на страницу
    private $index = 'page'; //     * @var Ключ для GET, в который пишется номер страницы
    private $current_page; //     * @var Текущая страница
    private $total; //     * @var Общее количество записей
    private $limit;//     * @var Записей на страницу
